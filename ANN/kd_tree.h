...
public:
	...
	virtual void ann_search(ANNdist, ANNQueryParam *pram) const = 0;		// tree search
	virtual void ann_pri_search(ANNdist, ANNPriQueryParam *pram) const = 0;	// priority search
	virtual void ann_FR_search(ANNdist, ANNFrQueryParam *pram) const = 0;	// fixed-radius search
...
public:
	...
	virtual void ann_search(ANNdist, ANNQueryParam *pram) const;			// standard search
	virtual void ann_pri_search(ANNdist, ANNPriQueryParam *pram) const;		// priority search
	virtual void ann_FR_search(ANNdist, ANNFrQueryParam *param) const;		// fixed-radius search
};
