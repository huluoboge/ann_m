...
public:
	...
	virtual void ann_search(ANNdist, ANNQueryParam *param) const;			// standard search
	virtual void ann_pri_search(ANNdist, ANNPriQueryParam *param) const;		// priority search
